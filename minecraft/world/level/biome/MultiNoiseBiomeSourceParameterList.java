...
public class MultiNoiseBiomeSourceParameterList {
   ...
   public static record Preset(Identifier id, MultiNoiseBiomeSourceParameterList.Preset.SourceProvider provider) {
      ...
      static final Map<Identifier, MultiNoiseBiomeSourceParameterList.Preset> BY_NAME;
      public static final Codec<MultiNoiseBiomeSourceParameterList.Preset> CODEC;

      public Preset(Identifier param1, MultiNoiseBiomeSourceParameterList.Preset.SourceProvider param2) {
         super();
         this.id = var1;
         this.provider = var2;
      }
      ...
      static {
         ...
         CODEC = Identifier.CODEC.flatXmap((var0) -> {
