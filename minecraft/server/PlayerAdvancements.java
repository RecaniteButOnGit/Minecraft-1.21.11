...
public class PlayerAdvancements {
   ...
   private static record Data(Map<Identifier, AdvancementProgress> map) {
      ...
      Data(Map<Identifier, AdvancementProgress> param1) {
         super();
         this.map = var1;
      }
      ...
      public void forEach(BiConsumer<Identifier, AdvancementProgress> var1) {
         this.map.entrySet().stream().sorted(Entry.comparingByValue()).forEach((var1x) -> {
            var1.accept((Identifier)var1x.getKey(), (AdvancementProgress)var1x.getValue());
         });
      }
      ...
      static {
         CODEC = Codec.unboundedMap(Identifier.CODEC, AdvancementProgress.CODEC).xmap(PlayerAdvancements.Data::new, PlayerAdvancements.Data::map);
      }
   }
}
