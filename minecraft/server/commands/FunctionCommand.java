...
public class FunctionCommand {
   ...
   private static <T extends ExecutionCommandSource<T>> CommandResultCallback decorateOutputIfNeeded(T var0, FunctionCommand.Callbacks<T> var1, Identifier var2, CommandResultCallback var3) {
