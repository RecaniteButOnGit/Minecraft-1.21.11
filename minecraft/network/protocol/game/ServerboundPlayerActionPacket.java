...
public class ServerboundPlayerActionPacket implements Packet<ServerGamePacketListener> {
   ...
   public static enum Action {
      ...
      private static ServerboundPlayerActionPacket.Action[] $values() {
         return new ServerboundPlayerActionPacket.Action[]{START_DESTROY_BLOCK, ABORT_DESTROY_BLOCK, STOP_DESTROY_BLOCK, DROP_ALL_ITEMS, DROP_ITEM, RELEASE_USE_ITEM, SWAP_ITEM_WITH_OFFHAND, STAB};
      }
   }
}
