...
public interface CubicSpline<C, I extends BoundedFloatFunction<C>> extends BoundedFloatFunction<C> {
   ...
   static <C, I extends BoundedFloatFunction<C>> Codec<CubicSpline<C, I>> codec(Codec<I> var0) {
      ...
      Codec var2 = RecordCodecBuilder.create((var1x) -> {
         return var1x.group(Codec.FLOAT.fieldOf("location").forGetter(1Point::location), Codec.lazyInitialized(var1).fieldOf("value").forGetter(1Point::value), Codec.FLOAT.fieldOf("derivative").forGetter(1Point::derivative)).apply(var1x, (var0, var1xx, var2) -> {
