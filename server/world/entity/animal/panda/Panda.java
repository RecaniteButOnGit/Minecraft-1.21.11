...
public class Panda extends Animal {
   ...
   private void addEatingParticles() {
      if (this.getEatCounter() % 5 == 0) {
         ...
         for(int var1 = 0; var1 < 6; ++var1) {
            Vec3 var2 = new Vec3(((double)this.random.nextFloat() - 0.5D) * 0.1D, (double)this.random.nextFloat() * 0.1D + 0.1D, ((double)this.random.nextFloat() - 0.5D) * 0.1D);
      ...
      if (this.rollCounter > 32) {
         ...
         if (!this.level().isClientSide()) {
            ...
            if (this.rollCounter == 1) {
               ...
               this.rollDelta = new Vec3(var1.x + (double)(-Mth.sin((double)var2) * var3), 0.0D, var1.z + (double)(Mth.cos((double)var2) * var3));
   ...
   private void afterSneeze() {
      ...
      var2.addParticle(ParticleTypes.SNEEZE, this.getX() - (double)(this.getBbWidth() + 1.0F) * 0.5D * (double)Mth.sin((double)(this.yBodyRot * 0.017453292F)), this.getEyeY() - 0.10000000149011612D, this.getZ() + (double)(this.getBbWidth() + 1.0F) * 0.5D * (double)Mth.cos((double)(this.yBodyRot * 0.017453292F)), var1.x, 0.0D, var1.z);
