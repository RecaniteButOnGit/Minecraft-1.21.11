...
public class LlamaSpit extends Projectile {
   ...
   public LlamaSpit(Level var1, Llama var2) {
      ...
      this.setOwner(var2);
      this.setPos(var2.getX() - (double)(var2.getBbWidth() + 1.0F) * 0.5D * (double)Mth.sin((double)(var2.yBodyRot * 0.017453292F)), var2.getEyeY() - 0.10000000149011612D, var2.getZ() + (double)(var2.getBbWidth() + 1.0F) * 0.5D * (double)Mth.cos((double)(var2.yBodyRot * 0.017453292F)));
   }
