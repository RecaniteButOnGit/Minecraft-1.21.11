      ...
      protected void performSpellCasting() {
         ...
         if (Evoker.this.distanceToSqr(var1) < 9.0D) {
            ...
            for(var7 = 0; var7 < 5; ++var7) {
               ...
               this.createSpellEntity(Evoker.this.getX() + (double)Mth.cos((double)var8) * 1.5D, Evoker.this.getZ() + (double)Mth.sin((double)var8) * 1.5D, var2, var4, var8, 0);
            }

            for(var7 = 0; var7 < 8; ++var7) {
               var8 = var6 + (float)var7 * 3.1415927F * 2.0F / 8.0F + 1.2566371F;
               this.createSpellEntity(Evoker.this.getX() + (double)Mth.cos((double)var8) * 2.5D, Evoker.this.getZ() + (double)Mth.sin((double)var8) * 2.5D, var2, var4, var8, 3);
            }
         } else {
            for(var7 = 0; var7 < 16; ++var7) {
               double var11 = 1.25D * (double)(var7 + 1);
               int var10 = 1 * var7;
               this.createSpellEntity(Evoker.this.getX() + (double)Mth.cos((double)var6) * var11, Evoker.this.getZ() + (double)Mth.sin((double)var6) * var11, var2, var4, var6, var10);
            }
         }
