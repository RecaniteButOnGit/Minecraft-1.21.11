...
public interface EnchantmentEffectComponents {
   ...
   DataComponentType<List<ConditionalEffect<EnchantmentEntityEffect>>> POST_PIERCING_ATTACK = register("post_piercing_attack", (var0) -> {
      return var0.persistent(ConditionalEffect.codec(EnchantmentEntityEffect.CODEC, LootContextParamSets.ENCHANTED_DAMAGE).listOf());
   });
