...
public interface LevelBasedValue {
   ...
   public static record Exponent(LevelBasedValue base, LevelBasedValue power) implements LevelBasedValue {
      public static final MapCodec<LevelBasedValue.Exponent> CODEC = RecordCodecBuilder.mapCodec((var0) -> {
         return var0.group(LevelBasedValue.CODEC.fieldOf("base").forGetter(LevelBasedValue.Exponent::base), LevelBasedValue.CODEC.fieldOf("power").forGetter(LevelBasedValue.Exponent::power)).apply(var0, LevelBasedValue.Exponent::new);
      });

      public Exponent(LevelBasedValue param1, LevelBasedValue param2) {
         super();
         this.base = var1;
         this.power = var2;
      }
