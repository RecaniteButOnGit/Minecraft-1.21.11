...
public record SwingAnimation(SwingAnimationType type, int duration) {
   ...
   public SwingAnimation(SwingAnimationType param1, int param2) {
      super();
      this.type = var1;
      this.duration = var2;
   }
   ...
   static {
      ...
      CODEC = RecordCodecBuilder.create((var0) -> {
         return var0.group(SwingAnimationType.CODEC.optionalFieldOf("type", DEFAULT.type).forGetter(SwingAnimation::type), ExtraCodecs.POSITIVE_INT.optionalFieldOf("duration", DEFAULT.duration).forGetter(SwingAnimation::duration)).apply(var0, SwingAnimation::new);
      });
