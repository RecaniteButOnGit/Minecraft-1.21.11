...
public final class Biome {
   public static final Codec<Biome> DIRECT_CODEC = RecordCodecBuilder.create((var0) -> {
      ...
      }), EnvironmentAttributeMap.CODEC_ONLY_POSITIONAL.optionalFieldOf("attributes", EnvironmentAttributeMap.EMPTY).forGetter((var0x) -> {
         return var0x.attributes;
   ...
   public static final Codec<Biome> NETWORK_CODEC = RecordCodecBuilder.create((var0) -> {
      return var0.group(Biome.ClimateSettings.CODEC.forGetter((var0x) -> {
         return var0x.climateSettings;
      }), EnvironmentAttributeMap.NETWORK_CODEC.optionalFieldOf("attributes", EnvironmentAttributeMap.EMPTY).forGetter((var0x) -> {
         return var0x.attributes;
      }), BiomeSpecialEffects.CODEC.fieldOf("effects").forGetter((var0x) -> {
         return var0x.specialEffects;
   ...
   Biome(Biome.ClimateSettings var1, EnvironmentAttributeMap var2, BiomeSpecialEffects var3, BiomeGenerationSettings var4, MobSpawnSettings var5) {
      super();
   ...
   public static class BiomeBuilder {
      ...
      public Biome.BiomeBuilder putAttributes(EnvironmentAttributeMap var1) {
         this.attributes.putAll(var1);
         return this;
      }

      public Biome.BiomeBuilder putAttributes(EnvironmentAttributeMap.Builder var1) {
         return this.putAttributes(var1.build());
      }

      public <Value> Biome.BiomeBuilder setAttribute(EnvironmentAttribute<Value> var1, Value var2) {
         this.attributes.set(var1, var2);
         return this;
      }

      public <Value, Parameter> Biome.BiomeBuilder modifyAttribute(EnvironmentAttribute<Value> var1, AttributeModifier<Value, Parameter> var2, Parameter var3) {
