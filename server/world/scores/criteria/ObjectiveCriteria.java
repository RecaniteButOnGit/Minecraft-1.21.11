...
public class ObjectiveCriteria {
   ...
   public static Optional<ObjectiveCriteria> byName(String var0) {
      ...
      if (var1 != null) {
         ...
         return var2 < 0 ? Optional.empty() : BuiltInRegistries.STAT_TYPE.getOptional(Identifier.bySeparator(var0.substring(0, var2), '.')).flatMap((var2x) -> {
            return getStat(var2x, Identifier.bySeparator(var0.substring(var2 + 1), '.'));
         });
      }
   }
