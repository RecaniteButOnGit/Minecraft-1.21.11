...
public class PlaceCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0) {
      ...
      }))))).then(Commands.literal("jigsaw").then(Commands.argument("pool", ResourceKeyArgument.key(Registries.TEMPLATE_POOL)).then(Commands.argument("target", IdentifierArgument.id()).then(((RequiredArgumentBuilder)Commands.argument("max_depth", IntegerArgumentType.integer(1, 20)).executes((var0x) -> {
         return placeJigsaw((CommandSourceStack)var0x.getSource(), ResourceKeyArgument.getStructureTemplatePool(var0x, "pool"), IdentifierArgument.getId(var0x, "target"), IntegerArgumentType.getInteger(var0x, "max_depth"), BlockPos.containing(((CommandSourceStack)var0x.getSource()).getPosition()));
      })).then(Commands.argument("position", BlockPosArgument.blockPos()).executes((var0x) -> {
         return placeJigsaw((CommandSourceStack)var0x.getSource(), ResourceKeyArgument.getStructureTemplatePool(var0x, "pool"), IdentifierArgument.getId(var0x, "target"), IntegerArgumentType.getInteger(var0x, "max_depth"), BlockPosArgument.getLoadedBlockPos(var0x, "position"));
      ...
      }))))).then(Commands.literal("template").then(((RequiredArgumentBuilder)Commands.argument("template", IdentifierArgument.id()).suggests(SUGGEST_TEMPLATES).executes((var0x) -> {
         return placeTemplate((CommandSourceStack)var0x.getSource(), IdentifierArgument.getId(var0x, "template"), BlockPos.containing(((CommandSourceStack)var0x.getSource()).getPosition()), Rotation.NONE, Mirror.NONE, 1.0F, 0, false);
      })).then(((RequiredArgumentBuilder)Commands.argument("pos", BlockPosArgument.blockPos()).executes((var0x) -> {
         return placeTemplate((CommandSourceStack)var0x.getSource(), IdentifierArgument.getId(var0x, "template"), BlockPosArgument.getLoadedBlockPos(var0x, "pos"), Rotation.NONE, Mirror.NONE, 1.0F, 0, false);
      })).then(((RequiredArgumentBuilder)Commands.argument("rotation", TemplateRotationArgument.templateRotation()).executes((var0x) -> {
         return placeTemplate((CommandSourceStack)var0x.getSource(), IdentifierArgument.getId(var0x, "template"), BlockPosArgument.getLoadedBlockPos(var0x, "pos"), TemplateRotationArgument.getRotation(var0x, "rotation"), Mirror.NONE, 1.0F, 0, false);
      })).then(((RequiredArgumentBuilder)Commands.argument("mirror", TemplateMirrorArgument.templateMirror()).executes((var0x) -> {
         return placeTemplate((CommandSourceStack)var0x.getSource(), IdentifierArgument.getId(var0x, "template"), BlockPosArgument.getLoadedBlockPos(var0x, "pos"), TemplateRotationArgument.getRotation(var0x, "rotation"), TemplateMirrorArgument.getMirror(var0x, "mirror"), 1.0F, 0, false);
      })).then(((RequiredArgumentBuilder)Commands.argument("integrity", FloatArgumentType.floatArg(0.0F, 1.0F)).executes((var0x) -> {
         return placeTemplate((CommandSourceStack)var0x.getSource(), IdentifierArgument.getId(var0x, "template"), BlockPosArgument.getLoadedBlockPos(var0x, "pos"), TemplateRotationArgument.getRotation(var0x, "rotation"), TemplateMirrorArgument.getMirror(var0x, "mirror"), FloatArgumentType.getFloat(var0x, "integrity"), 0, false);
      })).then(((RequiredArgumentBuilder)Commands.argument("seed", IntegerArgumentType.integer()).executes((var0x) -> {
         return placeTemplate((CommandSourceStack)var0x.getSource(), IdentifierArgument.getId(var0x, "template"), BlockPosArgument.getLoadedBlockPos(var0x, "pos"), TemplateRotationArgument.getRotation(var0x, "rotation"), TemplateMirrorArgument.getMirror(var0x, "mirror"), FloatArgumentType.getFloat(var0x, "integrity"), IntegerArgumentType.getInteger(var0x, "seed"), false);
