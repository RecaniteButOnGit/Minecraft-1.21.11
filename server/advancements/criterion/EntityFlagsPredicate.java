...
public record EntityFlagsPredicate(Optional<Boolean> isOnGround, Optional<Boolean> isOnFire, Optional<Boolean> isCrouching, Optional<Boolean> isSprinting, Optional<Boolean> isSwimming, Optional<Boolean> isFlying, Optional<Boolean> isBaby, Optional<Boolean> isInWater, Optional<Boolean> isFallFlying) {
   ...
   public EntityFlagsPredicate(Optional<Boolean> param1, Optional<Boolean> param2, Optional<Boolean> param3, Optional<Boolean> param4, Optional<Boolean> param5, Optional<Boolean> param6, Optional<Boolean> param7, Optional<Boolean> param8, Optional<Boolean> param9) {
      super();
   ...
   public Optional<Boolean> isInWater() {
      return this.isInWater;
   }

   public Optional<Boolean> isFallFlying() {
   ...
   public static class Builder {
      ...
      public EntityFlagsPredicate.Builder setIsInWater(Boolean var1) {
         this.isInWater = Optional.of(var1);
         return this;
      }

      public EntityFlagsPredicate.Builder setIsFallFlying(Boolean var1) {
