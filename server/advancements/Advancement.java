...
public record Advancement(Optional<Identifier> parent, Optional<DisplayInfo> display, AdvancementRewards rewards, Map<String, Criterion<?>> criteria, AdvancementRequirements requirements, boolean sendsTelemetryEvent, Optional<Component> name) {
   ...
   public Advancement(Optional<Identifier> param1, Optional<DisplayInfo> param2, AdvancementRewards param3, Map<String, Criterion<?>> param4, AdvancementRequirements param5, boolean param6, Optional<Component> param7) {
      super();
      this.parent = var1;
      this.display = var2;
      this.rewards = var3;
   ...
   static {
      ...
      CODEC = RecordCodecBuilder.create((var0) -> {
         return var0.group(Identifier.CODEC.optionalFieldOf("parent").forGetter(Advancement::parent), DisplayInfo.CODEC.optionalFieldOf("display").forGetter(Advancement::display), AdvancementRewards.CODEC.optionalFieldOf("rewards", AdvancementRewards.EMPTY).forGetter(Advancement::rewards), CRITERIA_CODEC.fieldOf("criteria").forGetter(Advancement::criteria), AdvancementRequirements.CODEC.optionalFieldOf("requirements").forGetter((var0x) -> {
   ...
   public static class Builder {
      ...
      public Advancement.Builder parent(Identifier var1) {
         this.parent = Optional.of(var1);
         return this;
      }

      public Advancement.Builder display(ItemStack var1, Component var2, Component var3, @Nullable Identifier var4, AdvancementType var5, boolean var6, boolean var7, boolean var8) {
      ...
      public Advancement.Builder display(ItemLike var1, Component var2, Component var3, @Nullable Identifier var4, AdvancementType var5, boolean var6, boolean var7, boolean var8) {
