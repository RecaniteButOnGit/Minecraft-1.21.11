...
public class BlockPos extends Vec3i {
   ...
   public BlockPos rotate(Rotation var1) {
      ...
      switch(var1) {
      case CLOCKWISE_90:
         var10000 = new BlockPos(-this.getZ(), this.getY(), this.getX());
         break;
      case CLOCKWISE_180:
         var10000 = new BlockPos(-this.getX(), this.getY(), -this.getZ());
         break;
   ...
   public static class MutableBlockPos extends BlockPos {
      ...
      public BlockPos.MutableBlockPos clamp(Direction.Axis var1, int var2, int var3) {
         BlockPos.MutableBlockPos var10000;
         switch(var1) {
         case X:
            var10000 = this.set(Mth.clamp(this.getX(), var2, var3), this.getY(), this.getZ());
            break;
         case Y:
            var10000 = this.set(this.getX(), Mth.clamp(this.getY(), var2, var3), this.getZ());
            break;
         case Z:
            var10000 = this.set(this.getX(), this.getY(), Mth.clamp(this.getZ(), var2, var3));
            break;
         default:
            throw new MatchException((String)null, (Throwable)null);
         }
