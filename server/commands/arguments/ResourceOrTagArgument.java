      ...
      if (var1.canRead() && var1.peek() == '#') {
         ...
         try {
            ...
            HolderSet.Named var5 = (HolderSet.Named)this.registryLookup.get(var9).orElseThrow(() -> {
               return ERROR_UNKNOWN_TAG.createWithContext(var1, var8, this.registryKey.identifier());
            });
         ...
         Holder.Reference var4 = (Holder.Reference)this.registryLookup.get(var3).orElseThrow(() -> {
            return ResourceArgument.ERROR_UNKNOWN_RESOURCE.createWithContext(var1, var2, this.registryKey.identifier());
         });
