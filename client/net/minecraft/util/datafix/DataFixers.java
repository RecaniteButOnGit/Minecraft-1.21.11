...
public class DataFixers {
   ...
   private static void addFixers(DataFixerBuilder var0) {
      ...
      var0.addFixer(new CriteriaRenameFix(var169, "Migrate cat variant advancement", "minecraft:husbandry/complete_catalogue", (var1x) -> {
         return (String)var170.getOrDefault(var1x, var1x);
      }));
      ...
      var0.addFixer(new CriteriaRenameFix(var175, "Migrate cat variant advancement for british shorthair", "minecraft:husbandry/complete_catalogue", (var1x) -> {
         return (String)var176.getOrDefault(var1x, var1x);
      }));
      ...
      var0.addFixer(new EntityAttributeBaseValueFix(var255, "Villager follow range fix undo", "minecraft:villager", "minecraft:follow_range", (var0x) -> {
         return var0x == 48.0D ? 16.0D : var0x;
      }));
      var0.addFixer(new EntityAttributeBaseValueFix(var255, "Bee follow range fix", "minecraft:bee", "minecraft:follow_range", (var0x) -> {
         return var0x == 48.0D ? 16.0D : var0x;
      }));
      var0.addFixer(new EntityAttributeBaseValueFix(var255, "Allay follow range fix", "minecraft:allay", "minecraft:follow_range", (var0x) -> {
         return var0x == 48.0D ? 16.0D : var0x;
      }));
      var0.addFixer(new EntityAttributeBaseValueFix(var255, "Llama follow range fix", "minecraft:llama", "minecraft:follow_range", (var0x) -> {
         return var0x == 40.0D ? 16.0D : var0x;
      }));
      var0.addFixer(new EntityAttributeBaseValueFix(var255, "Piglin Brute follow range fix", "minecraft:piglin_brute", "minecraft:follow_range", (var0x) -> {
         return var0x == 16.0D ? 12.0D : var0x;
      }));
      var0.addFixer(new EntityAttributeBaseValueFix(var255, "Warden follow range fix", "minecraft:warden", "minecraft:follow_range", (var0x) -> {
      ...
      var0.addFixer(new BlockPropertyRenameAndFix(var260, "CreakingHeartBlockStateFix", "minecraft:creaking_heart", "active", "creaking_heart_state", (var0x) -> {
      ...
      var0.addFixer(new BlockPropertyRenameAndFix(var269, "rename test block mode", "minecraft:test_block", "test_block_mode", "mode", (var0x) -> {
         return var0x;
      }));
      ...
      var0.addFixer(new AddFieldFix(var278, References.PLAYER, "style", (var0x) -> {
         return var0x.createString("minecraft:default");
      }, new String[]{"locator_bar_icon"}));
      var0.addFixer(new AddFieldFix(var278, References.ENTITY, "style", (var0x) -> {
         return var0x.createString("minecraft:default");
      }, new String[]{"locator_bar_icon"}));
