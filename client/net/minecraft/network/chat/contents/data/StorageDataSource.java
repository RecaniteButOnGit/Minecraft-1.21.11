...
public record StorageDataSource(Identifier id) implements DataSource {
   public static final MapCodec<StorageDataSource> MAP_CODEC = RecordCodecBuilder.mapCodec((var0) -> {
      return var0.group(Identifier.CODEC.fieldOf("storage").forGetter(StorageDataSource::id)).apply(var0, StorageDataSource::new);
   });

   public StorageDataSource(Identifier param1) {
      super();
      this.id = var1;
   }
