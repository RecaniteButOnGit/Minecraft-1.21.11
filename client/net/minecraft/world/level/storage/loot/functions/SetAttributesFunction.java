...
public class SetAttributesFunction extends LootItemConditionalFunction {
   ...
   public static SetAttributesFunction.ModifierBuilder modifier(Identifier var0, Holder<Attribute> var1, AttributeModifier.Operation var2, NumberProvider var3) {
   ...
   private static record Modifier(Identifier id, Holder<Attribute> attribute, AttributeModifier.Operation operation, NumberProvider amount, List<EquipmentSlotGroup> slots) {
      ...
      Modifier(Identifier param1, Holder<Attribute> param2, AttributeModifier.Operation param3, NumberProvider param4, List<EquipmentSlotGroup> param5) {
         super();
         this.id = var1;
         this.attribute = var2;
         this.operation = var3;
