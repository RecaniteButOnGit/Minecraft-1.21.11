...
public final class JigsawStructure extends Structure {
   ...
   public JigsawStructure(Structure.StructureSettings var1, Holder<StructureTemplatePool> var2, Optional<Identifier> var3, int var4, HeightProvider var5, boolean var6, Optional<Heightmap.Types> var7, JigsawStructure.MaxDistance var8, List<PoolAliasBinding> var9, DimensionPadding var10, LiquidSettings var11) {
      super(var1);
      this.startPool = var2;
   ...
   static {
      ...
      CODEC = RecordCodecBuilder.mapCodec((var0) -> {
         ...
         }), Identifier.CODEC.optionalFieldOf("start_jigsaw_name").forGetter((var0x) -> {
