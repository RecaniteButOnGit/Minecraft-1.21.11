   ...
   public void submit(IllusionerRenderState var1, PoseStack var2, SubmitNodeCollector var3, CameraRenderState var4) {
      if (var1.isInvisible) {
         ...
         for(int var6 = 0; var6 < var5.length; ++var6) {
            var2.pushPose();
            var2.translate(var5[var6].x + (double)Mth.cos((double)((float)var6 + var1.ageInTicks * 0.5F)) * 0.025D, var5[var6].y + (double)Mth.cos((double)((float)var6 + var1.ageInTicks * 0.75F)) * 0.0125D, var5[var6].z + (double)Mth.cos((double)((float)var6 + var1.ageInTicks * 0.7F)) * 0.025D);
