...
public class ItemInHandRenderer {
   ...
   private void renderPlayerArm(PoseStack var1, SubmitNodeCollector var2, int var3, float var4, float var5, HumanoidArm var6) {
      ...
      Identifier var17 = var15.getSkin().body().texturePath();
      if (var7) {
   ...
   private void applyEatTransform(PoseStack var1, float var2, HumanoidArm var3, ItemStack var4, Player var5) {
      ...
      float var8;
      if (var7 < 0.8F) {
         var8 = Mth.abs(Mth.cos((double)(var6 / 4.0F * 3.1415927F)) * 0.1F);
   ...
   public void renderHandsWithItems(float var1, PoseStack var2, SubmitNodeCollector var3, LocalPlayer var4, int var5) {
      ...
      if (var9.renderMainHand) {
         ...
         var13 = this.itemModelResolver.swapAnimationScale(this.mainHandItem) * (1.0F - Mth.lerp(var1, this.oMainHandHeight, this.mainHandHeight));
      ...
      if (var9.renderOffHand) {
         ...
         var13 = this.itemModelResolver.swapAnimationScale(this.offHandItem) * (1.0F - Mth.lerp(var1, this.oOffHandHeight, this.offHandHeight));
         ...
         if (var6.isEmpty()) {
            ...
            if (var6.is(Items.CROSSBOW)) {
               ...
               if (var1.isUsingItem() && var1.getUseItemRemainingTicks() > 0 && var1.getUsedItemHand() == var4 && !var13) {
                  ...
                  if (var17 > 0.1F) {
                     var18 = Mth.sin((double)((var16 - 0.1F) * 1.3F));
                     var19 = var17 - 0.1F;
                     var20 = var18 * var19;
               ...
               if (var1.isUsingItem() && var1.getUseItemRemainingTicks() > 0 && var1.getUsedItemHand() == var4) {
                  ItemUseAnimation var22 = var6.getUseAnimation();
                  if (!var22.hasCustomArmTransform()) {
                     this.applyItemArmTransform(var8, var12, var7);
                  }
                  ...
                  case TRIDENT:
                     ...
                     var8.translate(0.0F, 0.0F, var17 * 0.2F);
                     var8.scale(1.0F, 1.0F, 1.0F + var17 * 0.2F);
                     var8.mulPose((Quaternionfc)Axis.YN.rotationDegrees((float)var21 * 45.0F));
                     break;
                  case BRUSH:
                     ...
                     break;
                  case BUNDLE:
                     this.swingArm(var5, var8, var21, var12);
                     break;
                  case SPEAR:
                     var8.translate((float)var21 * 0.56F, -0.52F, -0.72F);
                     var16 = (float)var6.getUseDuration(var1) - ((float)var1.getUseItemRemainingTicks() - var2 + 1.0F);
                     SpearAnimations.firstPersonUse(var1.getTicksSinceLastKineticHitFeedback(var2), var8, var16, var12, var6);
                  }
                  ...
                  case WHACK:
                     ...
                     break;
                  case STAB:
                     SpearAnimations.firstPersonAttack(var5, var8, var21, var12);
                  }
               }
