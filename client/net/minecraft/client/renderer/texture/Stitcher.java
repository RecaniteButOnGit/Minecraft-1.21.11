...
public class Stitcher<T extends Stitcher.Entry> {
   ...
   public void registerSprite(T var1) {
      Stitcher.Holder var2 = new Stitcher.Holder(var1, smallestFittingMinTexel(var1.width() + this.padding * 2, this.mipLevel), smallestFittingMinTexel(var1.height() + this.padding * 2, this.mipLevel));
   ...
   private static record Holder<T extends Stitcher.Entry>(T entry, int width, int height) {
      ...
      Holder(T param1, int param2, int param3) {
         super();
         this.entry = var1;
         this.width = var2;
         this.height = var3;
   ...
   public static class Region<T extends Stitcher.Entry> {
      ...
      public void walk(Stitcher.SpriteLoader<T> var1, int var2) {
         if (this.holder != null) {
            ...
            while(var3.hasNext()) {
               Stitcher.Region var4 = (Stitcher.Region)var3.next();
               var4.walk(var1, var2);
            }
         }
