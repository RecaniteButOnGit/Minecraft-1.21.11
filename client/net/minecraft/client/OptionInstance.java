...
public final class OptionInstance<T> {
   ...
   public static enum UnitDouble implements OptionInstance.SliderableValueSet<Double> {
      ...
      // $FF: synthetic method
      public double toSliderValue(final Object param1) {
   ...
   public static record SliderableEnum<T>(List<T> values, Codec<T> codec) implements OptionInstance.SliderableValueSet<T> {
      public SliderableEnum(List<T> param1, Codec<T> param2) {
         super();
         this.values = var1;
         this.codec = var2;
      }
      ...
      public double toSliderValue(T var1) {
         if (var1 == this.values.getFirst()) {
            ...
            return var1 == this.values.getLast() ? 1.0D : Mth.map((double)this.values.indexOf(var1), 0.0D, (double)(this.values.size() - 1), 0.0D, 1.0D);
         }
      }
      ...
      public T fromSliderValue(double var1) {
         ...
         int var3 = Mth.floor(Mth.map(var1, 0.0D, 1.0D, 0.0D, (double)this.values.size()));
         return this.values.get(Mth.clamp(var3, 0, this.values.size() - 1));
      }
   ...
   interface IntRangeBase extends OptionInstance.SliderableValueSet<Integer> {
      ...
      default <R> OptionInstance.SliderableValueSet<R> xmap(final IntFunction<? extends R> var1, final ToIntFunction<? super R> var2, final boolean var3) {
         return new OptionInstance.SliderableValueSet<R>() {
            public Optional<R> validateValue(R var1x) {
      ...
      // $FF: synthetic method
      default Optional previous(final Object param1) {
         return this.previous((Integer)var1);
      }

      // $FF: synthetic method
      default Optional next(final Object param1) {
      ...
      public boolean keyPressed(KeyEvent var1) {
         if (var1.isSelection()) {
            ...
            if (this.canChangeValue) {
               ...
               Optional var4;
               if (var2) {
                  var4 = this.values.previous(this.values.fromSliderValue(this.value));
                  if (var4.isPresent()) {
               ...
               if (var3) {
                  var4 = this.values.next(this.values.fromSliderValue(this.value));
                  if (var4.isPresent()) {
                     this.setValue(this.values.toSliderValue(var4.get()));
                     return true;
                  }
