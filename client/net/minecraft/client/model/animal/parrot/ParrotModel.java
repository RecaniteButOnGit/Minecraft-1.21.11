...
public class ParrotModel extends EntityModel<ParrotRenderState> {
   ...
   public void setupAnim(ParrotRenderState var1) {
      ...
      case 1:
         ...
         var10000.xRot += Mth.cos((double)(var1.walkAnimationPos * 0.6662F)) * 1.4F * var1.walkAnimationSpeed;
         var10000 = this.rightLeg;
         var10000.xRot += Mth.cos((double)(var1.walkAnimationPos * 0.6662F + 3.1415927F)) * 1.4F * var1.walkAnimationSpeed;
      case 0:
      case 4:
      default:
         ...
         var10000.y += var4;
         var10000 = this.tail;
         var10000.xRot += Mth.cos((double)(var1.walkAnimationPos * 0.6662F)) * 0.3F * var1.walkAnimationSpeed;
         var10000 = this.tail;
         var10000.y += var4;
         var10000 = this.body;
         var10000.y += var4;
