...
public class HumanoidModel<T extends HumanoidRenderState> extends EntityModel<T> implements ArmedModel<T>, HeadedModel {
   ...
   public static enum ArmPose {
      ...
      ArmPose(final boolean param3, final boolean param4) {
         this.twoHanded = var3;
      ...
      private static HumanoidModel.ArmPose[] $values() {
         return new HumanoidModel.ArmPose[]{EMPTY, ITEM, BLOCK, BOW_AND_ARROW, THROW_TRIDENT, CROSSBOW_CHARGE, CROSSBOW_HOLD, SPYGLASS, TOOT_HORN, BRUSH, SPEAR};
      }
   }
}
