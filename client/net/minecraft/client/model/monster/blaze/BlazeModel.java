...
public class BlazeModel extends EntityModel<LivingEntityRenderState> {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      for(var4 = 0; var4 < 4; ++var4) {
         var5 = Mth.cos((double)var2) * 9.0F;
         var6 = -2.0F + Mth.cos((double)((float)(var4 * 2) * 0.25F));
         var7 = Mth.sin((double)var2) * 9.0F;
      ...
      for(var4 = 4; var4 < 8; ++var4) {
         var5 = Mth.cos((double)var2) * 7.0F;
         var6 = 2.0F + Mth.cos((double)((float)(var4 * 2) * 0.25F));
         var7 = Mth.sin((double)var2) * 7.0F;
         var1.addOrReplaceChild(getPartName(var4), var3, PartPose.offset(var5, var6, var7));
         ++var2;
      }
      ...
      for(var4 = 8; var4 < 12; ++var4) {
         var5 = Mth.cos((double)var2) * 5.0F;
         var6 = 11.0F + Mth.cos((double)((float)var4 * 1.5F * 0.5F));
         var7 = Mth.sin((double)var2) * 5.0F;
         var1.addOrReplaceChild(getPartName(var4), var3, PartPose.offset(var5, var6, var7));
         ++var2;
      }
   ...
   public void setupAnim(LivingEntityRenderState var1) {
      ...
      for(var3 = 4; var3 < 8; ++var3) {
         this.upperBodyParts[var3].y = 2.0F + Mth.cos((double)(((float)(var3 * 2) + var1.ageInTicks) * 0.25F));
         this.upperBodyParts[var3].x = Mth.cos((double)var2) * 7.0F;
         this.upperBodyParts[var3].z = Mth.sin((double)var2) * 7.0F;
         ++var2;
      }
      ...
      for(var3 = 8; var3 < 12; ++var3) {
         this.upperBodyParts[var3].y = 11.0F + Mth.cos((double)(((float)var3 * 1.5F + var1.ageInTicks) * 0.5F));
         this.upperBodyParts[var3].x = Mth.cos((double)var2) * 5.0F;
         this.upperBodyParts[var3].z = Mth.sin((double)var2) * 5.0F;
         ++var2;
      }
