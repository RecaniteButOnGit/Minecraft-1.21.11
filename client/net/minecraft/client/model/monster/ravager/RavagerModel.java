...
public class RavagerModel extends EntityModel<RavagerRenderState> {
   ...
   public void setupAnim(RavagerRenderState var1) {
      ...
      if (var3 > 0.0F) {
         ...
         var8 = var7 * Mth.sin((double)this.neck.xRot);
         ...
         var5 = -1.0F;
         var6 = -1.0F * Mth.sin((double)this.neck.xRot);
         this.neck.x = 0.0F;
         ...
         if (var10) {
            ...
            var8 = Mth.sin((double)(var1.roarAnimation * 3.1415927F * 0.25F));
      ...
      this.rightHindLeg.xRot = Mth.cos((double)(var5 * 0.6662F)) * var6;
      this.leftHindLeg.xRot = Mth.cos((double)(var5 * 0.6662F + 3.1415927F)) * var6;
      this.rightFrontLeg.xRot = Mth.cos((double)(var5 * 0.6662F + 3.1415927F)) * var6;
      this.leftFrontLeg.xRot = Mth.cos((double)(var5 * 0.6662F)) * var6;
   }
}
