...
public class LayerDefinitions {
   ...
   public static Map<ModelLayerLocation, LayerDefinition> createRoots() {
      ...
      ModelLayers.ZOMBIE_VILLAGER_BABY_ARMOR.putFrom(var66.map((var0x) -> {
         return var0x.apply(HumanoidModel.BABY_TRANSFORMER);
      }), var0);
      ...
      List var72 = ModelLayers.getKnownLocations().filter((var1x) -> {
         return !var71.containsKey(var1x);
      }).toList();
      if (!var72.isEmpty()) {
