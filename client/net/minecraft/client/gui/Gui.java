...
public class Gui {
         ...
         if (var3.isScoping()) {
            ...
            for(int var7 = 0; var7 < var6; ++var7) {
               ...
               if (var10 != null && var10.slot() == var8 && var10.cameraOverlay().isPresent()) {
                  this.renderTextureOverlay(var1, ((Identifier)var10.cameraOverlay().get()).withPath((var0) -> {
         ...
         if (this.minecraft.gameMode.getPlayerMode() != GameType.SPECTATOR || this.canRenderCrosshairForSpectator(this.minecraft.hitResult)) {
            if (!this.minecraft.debugEntries.isCurrentlyEnabled(DebugScreenEntries.THREE_DIMENSIONAL_CROSSHAIR)) {
               ...
               if (this.minecraft.options.attackIndicator().get() == AttackIndicatorStatus.CROSSHAIR) {
                  ...
                  int var10 = var1.guiHeight() / 2 - 7 + 16;
                  int var8 = var1.guiWidth() / 2 - 8;
                  if (var6) {
                     var1.blitSprite(RenderPipelines.CROSSHAIR, (Identifier)CROSSHAIR_ATTACK_INDICATOR_FULL_SPRITE, var8, var10, 16, 16);
                  } else if (var5 < 1.0F) {
                     int var9 = (int)(var5 * 17.0F);
                     var1.blitSprite(RenderPipelines.CROSSHAIR, (Identifier)CROSSHAIR_ATTACK_INDICATOR_BACKGROUND_SPRITE, var8, var10, 16, 4);
                     var1.blitSprite(RenderPipelines.CROSSHAIR, CROSSHAIR_ATTACK_INDICATOR_PROGRESS_SPRITE, 16, 4, 0, 0, var8, var10, var9, 4);
                  }
               }
            }
   ...
   public static Identifier getMobEffectSprite(Holder<MobEffect> var0) {
      return (Identifier)var0.unwrapKey().map(ResourceKey::identifier).map((var0x) -> {
      ...
      if (var3 != null) {
         ...
         if (this.minecraft.options.attackIndicator().get() == AttackIndicatorStatus.HOTBAR) {
            ...
            if (var14 < 1.0F) {
               ...
               var1.blitSprite(RenderPipelines.GUI_TEXTURED, (Identifier)HOTBAR_ATTACK_INDICATOR_BACKGROUND_SPRITE, var12, var11, 18, 18);
   ...
   private static enum HeartType {
      ...
      private HeartType(final Identifier param3, final Identifier param4, final Identifier param5, final Identifier param6, final Identifier param7, final Identifier param8, final Identifier param9, final Identifier param10) {
         this.full = var3;
