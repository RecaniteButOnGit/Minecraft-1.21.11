...
public class CreateWorldScreen extends Screen {
   ...
   private class GameTab extends GridLayoutTab {
      ...
      GameTab() {
         ...
         }, (Object)CreateWorldScreen.this.uiState.getGameMode()).withValues((Object[])(WorldCreationUiState.SelectedGameMode.SURVIVAL, WorldCreationUiState.SelectedGameMode.HARDCORE, WorldCreationUiState.SelectedGameMode.CREATIVE)).create(0, 0, 210, 20, CreateWorldScreen.GAME_MODEL_LABEL, (var1x, var2x) -> {
         ...
         CycleButton var5 = (CycleButton)var2.addChild(CycleButton.builder(Difficulty::getDisplayName, (Object)CreateWorldScreen.this.uiState.getDifficulty()).withValues((Object[])Difficulty.values()).create(0, 0, 210, 20, Component.translatable("options.difficulty"), (var1x, var2x) -> {
         ...
         CycleButton var6 = (CycleButton)var2.addChild(CycleButton.onOffBuilder(CreateWorldScreen.this.uiState.isAllowCommands()).withTooltip((var0) -> {
   ...
   private class WorldTab extends GridLayoutTab {
      ...
      WorldTab() {
         ...
         CycleButton var3 = (CycleButton)var2.addChild(CycleButton.builder(WorldCreationUiState.WorldTypeEntry::describePreset, (Object)CreateWorldScreen.this.uiState.getWorldType()).withValues(this.createWorldTypeValueSupplier()).withCustomNarration(CreateWorldScreen.WorldTab::createTypeButtonNarration).create(0, 0, 150, 20, Component.translatable("selectWorld.mapType"), (var1x, var2x) -> {
