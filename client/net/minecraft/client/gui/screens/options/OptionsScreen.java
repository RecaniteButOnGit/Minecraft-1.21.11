...
public class OptionsScreen extends Screen {
   ...
   public static CycleButton<Difficulty> createDifficultyButton(int var0, int var1, String var2, Minecraft var3) {
      return CycleButton.builder(Difficulty::getDisplayName, (Object)var3.level.getDifficulty()).withValues((Object[])Difficulty.values()).create(var0, var1, 150, 20, Component.translatable(var2), (var1x, var2x) -> {
