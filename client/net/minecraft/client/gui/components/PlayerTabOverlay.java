            ...
            for(var13 = 0; var13 < var8; ++var13) {
               ...
               if (var10) {
                  if (var13 * 2 + 1 < var7.displayedValue()) {
                     var5.blitSprite(RenderPipelines.GUI_TEXTURED, (Identifier)HEART_FULL_BLINKING_SPRITE, var2 + var13 * var11, var1, 9, 9);
                  }

                  if (var13 * 2 + 1 == var7.displayedValue()) {
                     var5.blitSprite(RenderPipelines.GUI_TEXTURED, (Identifier)HEART_HALF_BLINKING_SPRITE, var2 + var13 * var11, var1, 9, 9);
                  }
               }

               if (var13 * 2 + 1 < var6) {
                  var5.blitSprite(RenderPipelines.GUI_TEXTURED, (Identifier)(var13 >= 10 ? HEART_ABSORBING_FULL_BLINKING_SPRITE : HEART_FULL_SPRITE), var2 + var13 * var11, var1, 9, 9);
               }

               if (var13 * 2 + 1 == var6) {
                  var5.blitSprite(RenderPipelines.GUI_TEXTURED, (Identifier)(var13 >= 10 ? HEART_ABSORBING_HALF_BLINKING_SPRITE : HEART_HALF_SPRITE), var2 + var13 * var11, var1, 9, 9);
               }
            }
