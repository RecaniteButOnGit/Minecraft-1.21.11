...
public class PopupScreen extends Screen {
   ...
   PopupScreen(Screen var1, int var2, @Nullable Identifier var3, Component var4, Component var5, List<PopupScreen.ButtonOption> var6, @Nullable Runnable var7) {
      super(var4);
   ...
   public static class Builder {
      ...
      public PopupScreen.Builder setImage(Identifier var1) {
         this.image = var1;
         return this;
      }
