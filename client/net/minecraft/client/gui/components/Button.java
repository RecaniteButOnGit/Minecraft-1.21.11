...
public abstract class Button extends AbstractButton {
   ...
   public static class Builder {
      ...
      public Button build() {
         Button.Plain var1 = new Button.Plain(this.x, this.y, this.width, this.height, this.message, this.onPress, this.createNarration);
   ...
   public static class Plain extends Button {
      protected Plain(int var1, int var2, int var3, int var4, Component var5, Button.OnPress var6, Button.CreateNarration var7) {
