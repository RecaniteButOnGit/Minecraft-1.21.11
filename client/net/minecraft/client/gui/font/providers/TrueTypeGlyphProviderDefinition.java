...
public record TrueTypeGlyphProviderDefinition(Identifier location, float size, float oversample, TrueTypeGlyphProviderDefinition.Shift shift, String skip) implements GlyphProviderDefinition {
   private static final Codec<String> SKIP_LIST_CODEC;
   public static final MapCodec<TrueTypeGlyphProviderDefinition> CODEC;

   public TrueTypeGlyphProviderDefinition(Identifier param1, float param2, float param3, TrueTypeGlyphProviderDefinition.Shift param4, String param5) {
      super();
      this.location = var1;
      this.size = var2;
