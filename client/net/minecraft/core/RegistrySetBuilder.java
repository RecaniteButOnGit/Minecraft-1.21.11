...
public class RegistrySetBuilder {
   ...
   private <T> HolderLookup.RegistryLookup<T> createLazyFullPatchedRegistries(HolderOwner<T> var1, Cloner.Factory var2, ResourceKey<? extends Registry<? extends T>> var3, HolderLookup.Provider var4, HolderLookup.Provider var5, MutableObject<HolderLookup.Provider> var6) {
      ...
      if (var7 == null) {
         ...
         var9.listElements().forEach((var5x) -> {
            ...
            var7x.supplier = () -> {
               return var7.clone(var5x.value(), var4, (HolderLookup.Provider)var6.get());
            };
         ...
         var10.listElements().forEach((var5x) -> {
            ...
            var8.computeIfAbsent(var6x, (var6xx) -> {
               RegistrySetBuilder.LazyHolder var7x = new RegistrySetBuilder.LazyHolder(var1, var6x);
               var7x.supplier = () -> {
                  return var7.clone(var5x.value(), var5, (HolderLookup.Provider)var6.get());
               };
               return var7x;
            });
         });
   ...
   private static record BuildState(RegistrySetBuilder.UniversalOwner owner, RegistrySetBuilder.UniversalLookup lookup, Map<Identifier, HolderGetter<?>> registries, Map<ResourceKey<?>, RegistrySetBuilder.RegisteredValue<?>> registeredValues, List<RuntimeException> errors) {
      ...
      private BuildState(RegistrySetBuilder.UniversalOwner param1, RegistrySetBuilder.UniversalLookup param2, Map<Identifier, HolderGetter<?>> param3, Map<ResourceKey<?>, RegistrySetBuilder.RegisteredValue<?>> param4, List<RuntimeException> param5) {
         super();
         this.owner = var1;
         this.lookup = var2;
      ...
      public static RegistrySetBuilder.BuildState create(RegistryAccess var0, Stream<ResourceKey<? extends Registry<?>>> var1) {
         ...
         var0.registries().forEach((var1x) -> {
            var5.put(var1x.key().identifier(), RegistrySetBuilder.wrapContextLookup(var1x.value()));
         });
         var1.forEach((var2x) -> {
            var5.put(var2x.identifier(), var4);
         });
