...
public class ForceLoadCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0) {
      var0.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("forceload").requires(Commands.hasPermission(Commands.LEVEL_GAMEMASTERS))).then(Commands.literal("add").then(((RequiredArgumentBuilder)Commands.argument("from", ColumnPosArgument.columnPos()).executes((var0x) -> {
   ...
   private static int queryForceLoad(CommandSourceStack var0, ColumnPos var1) throws CommandSyntaxException {
      ...
      if (var5) {
         var0.sendSuccess(() -> {
            return Component.translatable("commands.forceload.query.success", Component.translationArg(var2), Component.translationArg(var4.identifier()));
         }, false);
         return 1;
      } else {
   ...
   private static int listForceLoad(CommandSourceStack var0) {
      ...
      if (var4 > 0) {
         ...
         if (var4 == 1) {
            var0.sendSuccess(() -> {
               return Component.translatable("commands.forceload.list.single", Component.translationArg(var2.identifier()), var5);
            }, false);
         } else {
            var0.sendSuccess(() -> {
               return Component.translatable("commands.forceload.list.multiple", var4, Component.translationArg(var2.identifier()), var5);
            }, false);
         }
      } else {
   ...
   private static int removeAll(CommandSourceStack var0) {
      ...
      var0.sendSuccess(() -> {
         return Component.translatable("commands.forceload.removed.all", Component.translationArg(var2.identifier()));
      }, true);
      return 0;
   }
      ...
      if (var4 >= -30000000 && var5 >= -30000000 && var6 < 30000000 && var7 < 30000000) {
         ...
         if (var12 > 256L) {
            ...
            if (var17 == 0) {
               ...
               if (var17 == 1) {
                  var0.sendSuccess(() -> {
                     return Component.translatable("commands.forceload." + (var3 ? "added" : "removed") + ".single", Component.translationArg(var16), Component.translationArg(var15.identifier()));
                  }, true);
               } else {
                  ChunkPos var22 = new ChunkPos(var8, var9);
                  ChunkPos var21 = new ChunkPos(var10, var11);
                  var0.sendSuccess(() -> {
                     return Component.translatable("commands.forceload." + (var3 ? "added" : "removed") + ".multiple", var17, Component.translationArg(var15.identifier()), Component.translationArg(var22), Component.translationArg(var21));
                  }, true);
               }
