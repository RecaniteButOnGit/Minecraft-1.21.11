      ...
      (new Thread("Realms-connect-task") {
         public void run() {
            ...
            try {
               ...
               RealmsConnect.this.connection = Connection.connectToServer(var1x, EventLoopGroupHolder.remote(var3.options.useNativeTransport()), var3.getDebugOverlay().getBandwidthLogger());
               if (RealmsConnect.this.aborted) {
                  return;
               }
